...
Class MY_Controller extends CI_Controller
{
	...
	function __construct()
	{
		...
		switch ($controller) {
			...
			default:
			{
				//xu ly du lieu o trang ben ngoai
	...
	private function _check_login()
	{
		...
		//doi ve laij chu thuong
		$controller=strtolower($controller);
		//neu chua dang nhap ma truy cap vao thi tra ve trang login
		...
		//neu admin da dang nap ma zo trang login thi chuyen ho ve trang chu admin
		if($login && $controller == 'login')
		{
